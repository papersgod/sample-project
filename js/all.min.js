function jumbotronToggle() {
  var t = $(".jumbotron h1").is(":visible"),
    e = $(".jumbotron-toggle"),
    n = $(".overview > h1").html();
  t
    ? (e.addClass("glyphicon-chevron-down").removeClass("glyphicon-chevron-up"),
      $(".overview").fadeOut(500, function () {
        $(".toolbar")
          .prepend(
            '<h3 class="pull-left" style="margin-top: 0px; font-weight: 100;">' +
              n +
              "</h3",
          )
          .hide()
    ...
    : (e.addClass("glyphicon-chevron-up").removeClass("glyphicon-chevron-down"),
...
if (
  (!(function (t, e) {
    ...
    function r(t) {
      var e = (xt[t] = {});
      return (
        ot.each(t.match(bt) || [], function (t, n) {
          e[n] = !0;
        }),
        e
      );
      ...
      if (ot.acceptData(t)) {
        ...
        if (
          ...
          return (
            ...
            "string" == typeof e
              ? ((o = r[e]), null == o && (o = r[ot.camelCase(e)]))
              : (o = r),
            o
          );
      }
          ...
          i.style &&
            ...
            e
              ? (r[s] || "none" !== n || (i.style.display = ""),
                "" === i.style.display &&
                  St(i) &&
                  (r[s] = ot._data(i, "olddisplay", k(i.nodeName))))
              : ((o = St(i)),
                ((n && "none" !== n) || !o) &&
    ...
    function A(t, e, n, i, o) {
      for (
        ...
        ("margin" === n && (s += ot.css(t, n + Nt[r], !0, o)),
          i
            ? ("content" === n && (s -= ot.css(t, "padding" + Nt[r], !0, o)),
              "margin" !== n &&
                (s -= ot.css(t, "border" + Nt[r] + "Width", !0, o)))
            : ((s += ot.css(t, "padding" + Nt[r], !0, o)),
              "padding" !== n &&
                (s += ot.css(t, "border" + Nt[r] + "Width", !0, o))));
      return s;
    }
    ...
    function q(t, e) {
      ...
      for (e = e ? 1 : 0; 4 > o; o += 2 - e)
        ((n = Nt[o]), (i["margin" + n] = i["padding" + n] = t));
      return (e && (i.opacity = i.width = t), i);
    }
    function F(t, e, n) {
      for (
        var i, o = (be[e] || []).concat(be["*"]), r = 0, s = o.length;
        s > r;
        r++
      )
    ...
    function O(t, e, n) {
      ...
      (n.queue ||
        ...
        1 === t.nodeType &&
          ...
          (u = ot.css(t, "display")),
          (c = "none" === u ? ot._data(t, "olddisplay") || k(t.nodeName) : u),
          "inline" === c &&
            "none" === ot.css(t, "float") &&
            (nt.inlineBlockNeedsLayout && "inline" !== k(t.nodeName)
              ? (f.zoom = 1)
      ...
      if (ot.isEmptyObject(p))
        "inline" === ("none" === u ? k(t.nodeName) : u) && (f.display = u);
      else {
        (m ? "hidden" in m && (h = m.hidden) : (m = ot._data(t, "fxshow", {})),
          r && (m.hidden = !h),
          h
            ? ot(t).show()
            : d.done(function () {
      ...
      var i,
        ...
        u = a.promise({
          ...
          stop: function (e) {
            ...
            return (
              e ? a.resolveWith(t, [u, e]) : a.rejectWith(t, [u, e]),
              this
            );
          },
        }),
    ...
    var ut = (function (t) {
        ...
        return (
          ...
          i(function (i, s, a, l) {
            var u,
              ...
              b = n ? (r || (i ? t : h || o) ? [] : s) : y;
            if ((n && n(y, b, a, l), o))
              for (u = g(b, f), o(u, [], a, l), c = u.length; c--; )
                (d = u[c]) && (b[f[c]] = !(y[f[c]] = d));
            if (i) {
              if (r || t) {
                if (r) {
        ...
        var o = n.length > 0,
          ...
          s = function (i, s, a, l, u) {
            var c,
              ...
              w = b.length;
            for (u && (S = s !== L && s); h !== w && null != (c = b[h]); h++) {
              if (r && c) {
                for (d = 0; (p = t[d++]); )
                  if (p(c, s, a)) {
                    l.push(c);
      ...
      try {
        (K.apply((J = Z.call(W.childNodes)), W.childNodes),
      ...
      ((w = e.support = {}),
          ...
          function (t) {
            ...
            return i !== L && 9 === i.nodeType && i.documentElement
              ? ((L = i),
                ...
                (O = []),
                (F = []),
                (w.qsa = vt.test(i.querySelectorAll)) &&
                  (o(function (t) {
                ...
                (w.matchesSelector = vt.test(
                  ...
                  o(function (t) {
                    ((w.disconnectedMatch = _.call(t, "div")),
                      _.call(t, "[s!='']:x"),
                      O.push("!=", st));
                  }),
                (F = F.length && new RegExp(F.join("|"))),
                (O = O.length && new RegExp(O.join("|"))),
                (e = vt.test(H.compareDocumentPosition)),
                (P =
                  e || vt.test(H.contains)
                    ? function (t, e) {
        ...
        (e.matchesSelector = function (t, n) {
          if (
            ...
            (n = n.replace(dt, "='$1']")),
            !(!w.matchesSelector || !q || (O && O.test(n)) || (F && F.test(n))))
          )
            try {
              var i = _.call(t, n);
              if (
        ...
        (e.attr = function (t, e) {
          ...
          var n = C.attrHandle[e.toLowerCase()],
            i =
              n && V.call(C.attrHandle, e.toLowerCase()) ? n(t, e, !q) : void 0;
          return void 0 !== i
            ? i
            : w.attributes || !q
              ? t.getAttribute(e)
          ...
          function (t, n) {
            ...
            for (a = t, l = [], u = C.preFilter; a; ) {
              ((!i || (o = ut.exec(a))) &&
                ...
                (o = ct.exec(a)) &&
                  ((i = o.shift()),
                  r.push({ value: i, type: o[0].replace(lt, " ") }),
                  (a = a.slice(i.length))));
              for (s in C.filter)
                !(o = ht[s].exec(a)) ||
                  (u[s] && !(o = u[s](o))) ||
          ...
          function (t, e, n, i) {
            ...
            if (((n = n || []), 1 === d.length)) {
              if (
                ...
                if (
                  ((e = (C.find.ID(s.matches[0].replace(wt, Ct), e) || [])[0]),
                  !e)
                )
                  return n;
                (u && (e = e.parentNode),
            ...
            return (
              (u || $(t, d))(i, e, !q, n, (bt.test(t) && c(e.parentNode)) || e),
              n
            );
          }),
        ...
        if ("string" == typeof t) {
          ...
          if (n[1]) {
            if (
              ...
              dt.test(n[1]) && ot.isPlainObject(e))
            )
              for (n in e)
        ...
        function (t, e) {
          ot.fn[t] = function (n, i) {
            ...
            return (
              ...
              this.length > 1 &&
                (yt[t] || (o = ot.unique(o)), vt.test(t) && (o = o.reverse())),
              this.pushStack(o)
            );
          };
        },
    ...
    ((ot.fn.ready = function (t) {
      ...
      (ot.ready.promise = function (e) {
        if (!wt)
          if (((wt = ot.Deferred()), "complete" === ht.readyState))
            setTimeout(ot.ready);
    ...
    (ot.extend({
      ...
      hasData: function (t) {
        return (
          (t = t.nodeType ? ot.cache[t[ot.expando]] : t[ot.expando]),
          !!t && !u(t)
        );
      },
      data: function (t, e, n) {
    ...
    ((ot.event = {
        ...
        if (g && (c = g.events)) {
          for (e = (e || "").match(bt) || [""], u = e.length; u--; )
            if (
              ...
              l &&
                !p.length &&
                ((d.teardown && d.teardown.call(t, h, g.handle) !== !1) ||
      ...
      trigger: function (e, n, i, o) {
        ...
        if (
          ...
          if (!o && !u.noBubble && !ot.isWindow(i)) {
            for (
              l = u.delegateType || f, qt.test(l + f) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              (p.push(a), (c = a));
      ...
      fix: function (t) {
        ...
        for (
          s ||
            (this.fixHooks[o] = s =
              Ht.test(o) ? this.mouseHooks : Lt.test(o) ? this.keyHooks : {}),
    ...
    ((Jt.optgroup = Jt.option),
      ...
      ot.extend({
        clone: function (t, e, n) {
          ...
          if (
            (nt.html5Clone || ot.isXMLDoc(t) || !Pt.test("<" + t.nodeName + ">")
              ? (r = t.cloneNode(!0))
        ...
        buildFragment: function (t, e, n, i) {
          for (
            var o, r, s, a, l, u, c, d = t.length, p = m(e), f = [], h = 0;
            d > h;
            h++
          )
            if (((r = t[h]), r || 0 === r))
      ...
      ot.fn.extend({
          ...
          return Dt(
            ...
            function (t) {
              var e = this[0] || {},
                ...
                i = this.length;
              if (void 0 === t)
                return 1 === e.nodeType ? e.innerHTML.replace(_t, "") : void 0;
              if (
                !(
                  "string" != typeof t ||
                  zt.test(t) ||
                  (!nt.htmlSerialize && Pt.test(t)) ||
                  (!nt.leadingWhitespace && Mt.test(t)) ||
                  Jt[(Bt.exec(t) || ["", ""])[1].toLowerCase()]
                )
              ) {
                t = t.replace(Wt, "<$1></$2>");
                try {
        ...
        domManip: function (t, e) {
          ...
          if (
            f ||
            (u > 1 && "string" == typeof p && !nt.checkClone && Ut.test(p))
          )
    ...
    (ot.extend({
      ...
      style: function (t, e, n, i) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          var o,
            ...
            l = t.style;
          if (
            ((e = ot.cssProps[a] || (ot.cssProps[a] = N(l, a))),
      ...
      css: function (t, e, n, i) {
        var o,
          ...
          a = ot.camelCase(e);
        return (
          (e = ot.cssProps[a] || (ot.cssProps[a] = N(t.style, a))),
          (s = ot.cssHooks[e] || ot.cssHooks[a]),
          s && "get" in s && (r = s.get(t, !0, n)),
          void 0 === r && (r = ee(t, e, i)),
          "normal" === r && e in de && (r = de[e]),
          "" === n || n
            ? ((o = parseFloat(r)), n === !0 || ot.isNumeric(o) ? o || 0 : r)
            : r
        );
      },
    }),
      ot.each(["height", "width"], function (t, e) {
        ot.cssHooks[e] = {
          get: function (t, n, i) {
            return n
              ? ae.test(ot.css(t, "display")) && 0 === t.offsetWidth
                ? ot.swap(t, ce, function () {
                    return j(t, e, i);
                  })
                : j(t, e, i)
              : void 0;
      ...
      nt.opacity ||
        (ot.cssHooks.opacity = {
          ...
          set: function (t, e) {
            ...
            ((n.zoom = 1),
              ((e >= 1 || "" === e) &&
                "" === ot.trim(r.replace(re, "")) &&
                n.removeAttribute &&
                (n.removeAttribute("filter"), "" === e || (i && !i.filter))) ||
                (n.filter = re.test(r) ? r.replace(re, o) : r + " " + o));
          },
        }),
    ...
    ((ot.Animation = ot.extend(P, {
      tweener: function (t, e) {
        ...
        for (var n, i = 0, o = t.length; o > i; i++)
          ((n = t[i]), (be[n] = be[n] || []), be[n].unshift(e));
      },
          ...
          return t && 3 !== r && 8 !== r && 2 !== r
            ? typeof t.getAttribute === Tt
              ...
              : ((1 === r && ot.isXMLDoc(t)) ||
                  ((e = e.toLowerCase()),
                  (i =
                    ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? Ce : we))),
                void 0 === n
        ...
        set: function (t, e, n) {
          return (
            e === !1
              ? ot.removeAttr(t, n)
              : ($e && ke) || !Ee.test(n)
                ? t.setAttribute((!ke && ot.propFix[n]) || n, n)
        ...
        propHooks: {
          tabIndex: {
            get: function (t) {
              ...
              return e
                ? parseInt(e, 10)
                : Ne.test(t.nodeName) || (Se.test(t.nodeName) && t.href)
                  ? 0
                  : -1;
            },
          },
    ...
    (ot.fn.extend({
          ...
          : this.each(
              ot.isFunction(t)
                ...
                : function () {
                    if ("string" === n)
                      for (
                        var e, i = 0, o = ot(this), r = t.match(bt) || [];
                        (e = r[i++]);
                      )
      ...
      hasClass: function (t) {
        for (var e = " " + t + " ", n = 0, i = this.length; i > n; n++)
          if (
            1 === this[n].nodeType &&
            (" " + this[n].className + " ").replace(De, " ").indexOf(e) >= 0
          )
            return !0;
        return !1;
      },
    ...
    try {
      ...
      ((qe = ht.createElement("a")), (qe.href = ""), (qe = qe.href));
    }
    ((He = Be.exec(qe.toLowerCase()) || []),
      ot.extend({
        active: 0,
        lastModified: {},
        etag: {},
              ...
              o
                ? (d.ifModified &&
                  ...
                  204 === t || "HEAD" === d.type
                    ...
                    : 304 === t
                      ? (C = "notmodified")
                      : ((C = y.state), (c = y.data), (v = y.error), (o = !v)))
                : ((v = C), (t || !C) && ((C = "error"), 0 > t && (t = 0))),
              (w.status = t),
              (w.statusText = (e || C) + ""),
              o ? h.resolveWith(p, [c, C, w]) : h.rejectWith(p, [w, C, v]),
              w.statusCode(g),
              (g = void 0),
              l &&
                f.trigger(o ? "ajaxSuccess" : "ajaxError", [w, d, o ? c : v]),
              m.fireWith(p, [w, C]),
              l &&
                (f.trigger("ajaxComplete", [w, d]),
    ...
    ((ot.offset = {
      ...
      ot.each(["top", "left"], function (t, e) {
        ot.cssHooks[e] = $(nt.pixelPosition, function (t, n) {
          return n
            ? ((n = ee(t, e)), ie.test(n) ? ot(t).position()[e] + "px" : n)
            : void 0;
        });
      }),
      ...
      (e && e.preventDefault(),
        ...
        e.isDefaultPrevented() ||
          ...
          t.support.transition && r.hasClass("fade")
            ? r.one(t.support.transition.end, n).emulateTransitionEnd(150)
            : n()));
    };
    var i = t.fn.alert;
    ...
    ((t.fn.carousel = function (n) {
      ...
      t(document).on(
        ...
        function (e) {
          ...
          (s && (r.interval = !1),
            o.carousel(r),
            (s = i.attr("data-slide-to")) && o.data("bs.carousel").to(s),
            e.preventDefault());
        },
      ),
      ...
      (e.prototype.show = function () {
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if ((this.$element.trigger(e), !e.isDefaultPrevented())) {
            ...
            this.$element
              .one(t.support.transition.end, t.proxy(r, this))
      ...
      if (!o.is(".disabled, :disabled")) {
        ...
        if ((e(), !s)) {
          ...
          if (
            ...
            return;
          (r.toggleClass("open").trigger("shown.bs.dropdown", a), o.focus());
        }
        return !1;
      }
    }),
        ...
        if (/(38|40|27)/.test(e.keyCode)) {
          ...
          if (
            ...
            var r = n(i),
              s = r.hasClass("open");
            if (!s || (s && 27 == e.keyCode))
              return (27 == e.which && r.find(o).focus(), i.click());
    ...
    ((e.DEFAULTS = {
      ...
      (e.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          var g = this.getCalculatedOffset(o, a, l, u);
          (this.applyPlacement(g, o), (this.hoverState = null));
          var v = function () {
            n.$element.trigger("shown.bs." + n.type);
          };
          t.support.transition && this.$tip.hasClass("fade")
            ? i.one(t.support.transition.end, v).emulateTransitionEnd(150)
            : v();
        }
      }),
  ...
  +(function (t) {
    ...
    ((e.prototype.show = function () {
      ...
      (e.prototype.activate = function (e, n, i) {
        ...
        (s ? r.one(t.support.transition.end, o).emulateTransitionEnd(150) : o(),
          r.removeClass("in"));
      }));
    var n = t.fn.tab;
    ((t.fn.tab = function (n) {
...
var prettyPrint = (function () {
  ...
  function t(t, e, n, i, o) {
    var r = "<span class=json-key>",
      s = "<span class=json-value>",
      a = "<span class=json-string>",
      l = e || "";
    return (
      n && (l = l + r + n.replace(/[: ]/g, "") + "</span>: "),
      i && (l = l + ('"' == i[0] ? a : s) + i + "</span>"),
      l + (o || "")
    );
  }
  function e(e) {
