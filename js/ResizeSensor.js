          ...
          if (t.resizedAttached) t.resizedAttached.add(n);
            ...
            ((t.resizedAttached = new (function () {
              ...
              ((this.add = function (e) {
                ...
                (this.call = function () {
                  for (e = 0, t = i.length; e < t; e++) i[e].call();
                }),
            ...
            var r = window.getComputedStyle(t).getPropertyPriority("position");
            "absolute" !== r &&
              "relative" !== r &&
              "fixed" !== r &&
