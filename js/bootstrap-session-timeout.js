!(function (e) {
  ...
  e.sessionTimeout = function (t) {
    var o,
      ...
      n = i,
      s = {};
    if ((t && (n = e.extend(i, t)), n.warnAfter >= n.redirAfter)) return !1;
    if ("function" != typeof n.onWarn) {
      var a = n.countdownMessage
          ? "<p>" +
            n.countdownMessage.replace(
              /{timer}/g,
          ...
          : "",
        r = n.countdownBar
          ? '<div class="progress">                   <div class="progress-bar progress-bar-striped countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;">                     <span class="countdown-holder" style="color:black; font-size: 1rem; font-weight: bold;"></span>                   </div>                 </div>'
          : "";
      (e("body").append(
        ...
        e("#session-timeout-dialog-logout").on("click", function () {
          window.location = n.logoutUrl;
        }),
        e("#session-timeout-dialog").on("hide.bs.modal", function () {
          u();
        }));
    }
    if (!n.ignoreUserActivity) {
      var d = [-1, -1];
      e(document).on(
        "keyup mouseup mousemove touchend touchmove",
        function (t) {
          if ("mousemove" === t.type) {
            if (t.clientX === d[0] && t.clientY === d[1]) return;
            ((d[0] = t.clientX), (d[1] = t.clientY));
          }
          (u(),
    ...
    function u() {
      (clearTimeout(o),
        (n.countdownMessage || n.countdownBar) && c("session", !0),
        "function" == typeof n.onStart && n.onStart(n),
        n.keepAlive &&
          (l ||
            (e.ajax({
              type: n.ajaxType,
        ...
        (o = setTimeout(function () {
          ("function" != typeof n.onWarn
            ? e("#session-timeout-dialog").modal("show")
            : n.onWarn(n),
            (function () {
              (clearTimeout(o),
                e("#session-timeout-dialog").hasClass("in") ||
                  (!n.countdownMessage && !n.countdownBar) ||
                  c("dialog", !0));
              o = setTimeout(function () {
                "function" != typeof n.onRedir
                  ? (window.location = n.redirUrl)
                  : n.onRedir(n);
    ...
    function c(t, o) {
      (clearTimeout(s.timer),
        "dialog" === t && o
          ? (s.timeLeft = Math.floor((n.redirAfter - n.warnAfter) / 1e3))
          : "session" === t &&
            o &&
            (s.timeLeft = Math.floor(n.redirAfter / 1e3)),
        n.countdownBar && "dialog" === t
          ? (s.percentLeft = Math.floor(
              (s.timeLeft / ((n.redirAfter - n.warnAfter) / 1e3)) * 100,
            ))
          : n.countdownBar &&
            "session" === t &&
            (s.percentLeft = Math.floor(
              (s.timeLeft / (n.redirAfter / 1e3)) * 100,
            )));
      var i = e(".countdown-holder"),
        a = s.timeLeft >= 0 ? s.timeLeft : 0;
      if (n.countdownSmart) {
        var r = Math.floor(a / 60),
          d = a % 60,
          l = r > 0 ? r + "m" : "";
        (l.length > 0 && (l += " "), (l += d + "s"), i.text(l));
      } else i.text(a + "s");
      (n.countdownBar && e(".countdown-bar").css("width", s.percentLeft + "%"),
